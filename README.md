...
```bash
git clone https://github.com/viktor-sonin/redux-todo.git
npm install
npm run dev
```
...
Селектор для фильтрации Todo-шек по зарешненности задачи
...
Селектор для сортировки Todo-шек по дате
